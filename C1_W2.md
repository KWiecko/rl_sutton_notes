...
<p align="center">
    ...
    <img height="25px" src="https://latex.codecogs.com/svg.latex?\Large&space;G_{t}=R_{t+1}+\gamma R_{t+2}+\gamma^2 R_{t+3} + \gamma^3 R_{t+4}+... = R_{t+1} + \gamma (R_{t+2} + \gamma R_{t+3} + \gamma^2 R_{t+4}+... )=R_{t+1}+\gamma G_{t+1}" title="\Large G_{t}=R_{t+1}+\gamma R_{t+2}+\gamma^2 R_{t+3} + \gamma^3 R_{t+4}+... = R_{t+1} + \gamma (R_{t+2} + \gamma R_{t+3} + \gamma^2 R_{t+4}+... ) = R_{t+1}+\gamma G_{t+1}" />
[comment]: <> (    <img height="25px" src="https://latex.codecogs.com/svg.latex?\Large&space;G_{t}=R_{t+1}+\gamma R_{t+2}+\gamma^2 R_{t+3} + \gamma^3 R_{t+4}+... = R_{t+1} + \gamma &#40;R_{t+2} + \gamma R_{t+3} + \gamma^2 R_{t+4}+... &#41;=R_{t+1}+\gamma G_{t+1}">)
</p>
...
<p align="center">
    <img height="25px" src="https://latex.codecogs.com/svg.latex?\Large&space;G_{t} = \sum_{k=0}^{\infin} \gamma^{k} = \frac{1}{1-\gamma}">
</p>
